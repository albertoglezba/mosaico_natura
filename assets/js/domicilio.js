...
$(document).ready(
		function() {
			...
			function reseteaDomicilio () 
			{
				...
				$('#Usuarios_estado').val('').removeAttr('checked').removeAttr('selected');
			...
			$('#Usuarios_estado, #municipio_lista, ciudad_id, asentamiento_lista, tipo_asentamiento_id').bind("change", function() {
				$('#codigo_postal').val('');
				
			});
			
			$('#Usuarios_estado_manual, ciudad, municipio, asentamiento').keyup(function(){
				$('#codigo_postal').val('');
			 ...
			 */
			$("#Usuarios_estado").bind("change", function() {
				...
				$('#codigo_postal, #municipio, #asentamiento, #ciudad, #Usuarios_estado_manual').val('');
			...
			$('#Usuarios_cp').keyup(function() { 
				...
				if (datos != '0') 
				{
	    			...
	    			$('#Usuarios_estado_manual').slideUp();
	    			$('#Usuarios_estado').slideDown();
	    			$('#ciudad, #municipio, #asentamiento, #Usuarios_estado_manual').val('');
					...
					$('#Usuarios_estado option[value="' + tags[0] + '"]').attr("selected", "selected");

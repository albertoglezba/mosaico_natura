...
class UserIdentity extends CUserIdentity
{
    ...
    public function authenticate()
    {
        ...
        if($credenciales != NULL)
        {
            ...
            elseif($users[$this->username]!==md5($this->password."|".$users['salt']))
            {
                ...
                $errores['descripcion'] = 'Correo o contraseña inválidos.';
            }
            elseif ($users[$this->username]===md5($this->password."|".$users['salt']))
            {
            ...
            $errores['descripcion'] = 'Este correo no existe en nuestra base';
    ...
    {
        return Usuarios::model()->findByAttributes(array('correo'=>$usr));
    }
}
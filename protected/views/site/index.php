        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-3">
                  <h2 class="mosaico-titulo">Quinto Concurso Nacional</h2>
                </div>
                <div class="col-md-8 col-md-offset-4">
                    <h3 class="mosaico-titulo">de Fotograf&iacute;a de Naturaleza</h3>
                    <h4 class="mosaico-titulo" align="center"><i>Próximamente</i></h4>
...
<section id="about" class="container content-section text-center">
    <div class="row">
        <div class="col-lg-7">
            ...
            <p><img src="<?php echo $yii_path; ?>/img/logo-mosaiconaturav.png" width="130" height="71" alt="" class="media-bottom"/> tiene como objetivos: ser una ventana para dar a conocer la riqueza natural de México a través de la fotografía y ser un sitio de promoción para fotógrafos de naturaleza mexicana.</p>

            <p>Si te interesa difundir tu trabajo como fotógrafo de naturaleza, inscríbete al concurso y envía tus mejores fotos. Los ganadores participaran en exposiciones fotográficas y publicaciones en diversas plataformas impresas y digitales.</p>
...
<!-- Bases Section -->
<section id="bases" class="content-section text-center Sconvoca">
    ...
    <div class="bases-content">
      <div class="container">	
            ...
            <div class="col-lg-12 col-xs-12 bases-titulo">
                <h3>CATEGOR&Iacute;AS Y TEMAS</h3>
            </div>
			<div class="col-lg-12 col-xs-12">
				<h3>ADULTOS   <i class="fa fa-caret-right"></i> <span  class="pleca_ama">  18 ños en adelante. |  Cada participante podrá enviar hasta 2 fotografías por tema.</span></h3>
				<h3>J&Oacute;VENES		<i class="fa fa-caret-right"></i>   <span class="pleca_ama"> 17 años al cierre del concurso. | Cada participante podrá enviar hasta 3 fotografías de tema libre</span></h3>
			</div>
            <div class="col-md-6 col-xs-12"> 
                ...
                <div class="categorias-adultos">
                    <dl class="dl-horizontal">
                        ...
                        <dd><span style="color:#4b5051; font-weight:bold;">Plantas y Hongos</span><br/> Incluye toda clase de especies vegetales y hongos nativos de Mexico, en vida silvestre. No se aceptarán fotografías de plantas cultivadas, de maceta o jardín.</dd>
            ...
            <div class="col-md-6 col-xs-12">		
              <div class="categorias-adultos">
                    ...
                    <dl class="dl-horizontal">
                        ...
                        <dd><span style="color:#4b5051; font-weight:bold;">Tema libre (Jóvenes menores de 18 años)</span><br/> Incluye cualquier fotografía relacionada con la riqueza natural de México, es decir, animales o plantas en su ambiente natural, paisajes naturales, actividades relacionadas con el hombre y la naturaleza. No se aceptarán fotografías de plantas cultivadas, animales en cautiverio o cualquier otro ambiente controlado.</dd>
                    </dl>
              </div>
			</div>
		    ...
		    <div class="col-lg-12 col-xs-12">
				<h3>Exhibición	de	fotografías finalistas   <i class="fa fa-caret-right"></i>   <span class="pleca_ama"> Rejas de Chapultepec. Del 14 de abril al 14 de julio de 2019</span></h3>
			</div>

          <div class="col-md-6 col-xs-12"> 
		    <div>
                    <p><strong>Premios por cada tema</strong><br/>
                      Categoría Adultos</p><br>
              </div>

            <table class="tabla-premios-adulto" width="80%" border="0" cellpadding="0" cellspacing="0" align="center">
                    <tr>
                        <td valign="bottom"><img src="<?php echo $yii_path; ?>/img/bases-06_2019.png">
                            <table width="100%" border="3" cellpadding="0" cellspacing="0" style="border-color:#CFCFCF; border-style:solid; border-right-width:0">
                                <tr>
                                    <td bgcolor="#e0e0de" style="padding:10px 3px;"><p>&nbsp;</p>
                                      <p><span style="font-size:30px;">$20,000</span><br>
                                      pesos en efectivo<br>
                                      </p>
                                  </td>
                                </tr>
                            </table>
                        </td>
                        <td valign="bottom"><img src="<?php echo $yii_path; ?>/img/bases-07_2019.png">
                            <table width="100%" border="3" cellpadding="0" cellspacing="0" style="border-color:#CFCFCF; border-style:solid;">
                                <tr>
                                    <td bgcolor="#e0e0de" style="padding:15px 2px;"><p>&nbsp;</p>
                                      <p><span style="font-size:30px;">$25,000</span><br>                                      
                                      pesos en  efectivo</p>
                                      <p>&nbsp;</p>
                                      <p><br>
                                    </p></td>
                        ...
                        <td valign="bottom"><img src="<?php echo $yii_path; ?>/img/bases-08_2019.png">
                            <table width="100%" border="3" cellpadding="0" cellspacing="0" style="border-color:#CFCFCF; border-style:solid; border-left-width:0">
                                <tr>
                                    <td bgcolor="#e0e0de" style="padding:10px 3px;"><p>&nbsp;</p>
                                      <p><span style="font-size:30px;">$15,000</span><br>                                      
                                      pesos en efectivo</p></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
          ...
          <div class="col-md-6 col-xs-12"> 
		    <div>
					   <p><strong>Premios por tema libre</strong><br/>
                      Categoría Jóvenes</p><br>
		    </div>
            <table class="tabla-premios-adulto" width="80%" border="0" cellpadding="0" cellspacing="0" align="center">
                    <tr>
                        <td valign="bottom"><img src="<?php echo $yii_path; ?>/img/bases-06_2019.png">
                        ...
                        <td valign="bottom"><img src="<?php echo $yii_path; ?>/img/bases-08_2019.png">
                            <table width="100%" border="3" cellpadding="0" cellspacing="0" style="border-color:#CFCFCF; border-style:solid; border-left-width:0">
                                <tr>
                                    <td bgcolor="#e0e0de" style="padding:15px 2px;"><p>&nbsp;</p>
                                      <p><span style="font-size:30px;">$10,000</span><br>                                      
                                      pesos en efectivo</p></td>
                                </tr>
                            </table>
                        </td>
		  ...
		  <div id="participar-md" class="col-lg-12">
                    <div class="faq-formatos" align="center">
						<br>
                        <img src="<?php echo $yii_path; ?>/img/faq-10.png">
                        <ul>
                            ...
                            <li><a href="<?php echo $yii_path; ?>descargar/tutorial_foto.pdf" target="_blank" style="color: darkred"><i class="fa fa-caret-right"></i>  Ver tutorial</a></li>
            ...
            <div id="participar-md" class="col-lg-12">
                <table class="como-participar" width="100%" border="0">
                    <tr>
                        <td>Entra a <a href="#" style="color: darkred">www.mosaiconatura.net</a><br/>y crea una cuenta</td>
                        <td><img src="<?php echo $yii_path; ?>/img/bases-17_2019.png"></td>
                        ...
                        <td><img src="<?php echo $yii_path; ?>/img/bases-17_2019.png"></td>
                        <td>Los resultados ser&aacute;n publicados en<br> <a href="#" style="color: darkred">www.mosaiconatura.net</a> </td>
                    </tr>
                </table>
            </div>

            <div id="participar-xs" class="col-md-12 col-xs-12">
                <p>Entra a <a href="#" style="color: darkred">www.mosaiconatura.net</a><br/>y crea una cuenta</p>
            ...
            <div class="col-xs-12 col-md-8 col-md-offset-2 fechas-concurso">
                <p>La recepci&oacute;n de fotograf&iacute;as ser&aacute; del ? de enero 2019 (12:00hrs) al ? de marzo 2019 (23:00hrs)<br></p><br>
				<p><a style="color: darkred" href="<?php echo Yii::app()->baseUrl;?>/index.php/site/terminos_condiciones">T&eacute;rminos y condiciones</a></p>
            </div>
    ...
    <div class="expos-content">
        <div class="container">
          ...
          <div class="col-md-4">
            ...
            <div class="col-md-6">
                <img src="<?php echo $yii_path; ?>/img/svg/NatGeo.svg" width="40%">
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-xs-12 caractsm">
                    ...
                    <div class="faqdiv">
                        <img src="<?php echo $yii_path; ?>/img/faq-04.png">
                        <p>3. Recibir&aacute;s un correo de confirmaci&oacute;n</p>
                    </div>
                    <div class="faqdiv">
                        <img src="<?php echo $yii_path; ?>/img/faq-05.png">
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    ...
                    <img src="<?php echo $yii_path; ?>/img/faq-11.png">
                ...
                <div class="col-lg-5">
                    <div class="faq-formatos-video">
                        ...
                        <ul>
                            ...
                            <li>Duraci&oacute;n de 60 a 120 segundos</li>
                            <li>Sin marcas de agua</li>
            ...
            <div class="col-lg-4 col-md-6 col-xs-12 text-center">
                <div class="service-box">
                    ...
                    <!--<a class="list-group-item sb" href="img/infografia_150.jpg" target="_blank"><i class="fa fa-download fa-fw"></i> 1000 x 700</a>
                        <a href="img/infografia_150.jpg" target="_blank"><img src="<?php echo $yii_path; ?>/img/infografia_150.jpg" width="100%" height="auto"></a>-->
                    <!--</div>-->
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-xs-12 text-center">

        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-3">
                    <h2 class="mosaico-titulo">Cuarto Concurso Nacional</h2>
                </div>
    ...
    <div class="bases-content">
        <div class="container">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <h3>ADULTOS <i class="fa fa-caret-right"></i>   <span  class="pleca_ama">Hasta 25 fotos por participante, 5 por cada tema</span></h3>
                ...
                <div id="formatos-wrapper">
                    <div class="faq-formatos">
                        <img src="<?php echo $yii_path; ?>/img/bases-10.png">
                        <ul>
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="vid-formato">
                    <img src="<?php echo $yii_path; ?>/img/bases-13.png">
                    <ul>
                ...
                <div id="adv-specs">
                    <p>Especificaciones avanzadas:<br/>Codecs opcionales: ProRes, DVCPRO HD 1080 p30, Photo JPG</p>
                </div>
